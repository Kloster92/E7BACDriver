...
Udover at mindske ripplespændingen på udgangen, har udgangskondensatoren to egenskaber. Den skal . Derudover er den, sammen med load modstanden, en del af en dominerende pol i converter trinet. Disse egenskaber vil blive uddybet nærmere i de følgende iterationer. 
...
\subsection{Current sense kredsløb}
